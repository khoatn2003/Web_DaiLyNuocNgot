        ...
        <div className="mx-auto max-w-6xl px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label="Mở menu"
              onClick={() => { setOpen((v) => !v); setMobileProductOpen(false); }}
            >
    ...
    {open && (
      <div className="md:hidden border-t border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-3 flex flex-col gap-2">
          {nav.map((i) =>
            i.children ? (
              <div key={i.href} className="rounded-lg overflow-hidden">
                <button
                  type="button"
                  className="w-full py-2 text-sm rounded-lg px-2 hover:bg-white/10 flex items-center justify-between"
                ...
                {mobileProductOpen && (
                  <div className="mt-1 ml-2 border-l border-white/15 pl-3">
                    <Link
                      href={i.href}
                      className="block py-2 text-sm rounded-lg px-2 hover:bg-white/10 opacity-90"
                      onClick={() => {
